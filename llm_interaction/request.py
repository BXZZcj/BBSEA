...
from config.core import prompts_path, gpt_api_key
...
def gpt_35_api(messages: list, temperature):
    completion = client.chat.completions.create(model="gpt-3.5-turbo", messages=messages, temperature=temperature)
